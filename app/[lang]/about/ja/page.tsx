            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <article className="prose prose-lg max-w-none">
                    ...
                    <ul className="list-disc pl-6 text-gray-700 space-y-2">
                        ...
                        <li>
                            <strong>レイアウトの自動計算</strong>
                            ：アーキテクチャ図、フローチャート、スイムレーン図、シーケンス図、マインドマップ、組織図では、AI
                            は構造だけを指定し、座標・サイズ・矢印の経路はすべてアプリが計算します——コンテナは必ず中身が収まり、図形は重ならず、矢印は本来通り抜けてしまう図形を避けて引かれます
                        </li>
                        <li>
