...
> 注：感谢 <a href="https://console.volcengine.com/ark/region:ark+cn-beijing/overview?briefPage=0&briefType=introduce&type=new&utm_campaign=doubao&utm_content=aidrawio&utm_medium=github&utm_source=coopensrc&utm_term=project"><img src="https://raw.githubusercontent.com/DayuanJiang/next-ai-draw-io/main/public/doubao-color.svg" alt="字节跳动豆包" height="20" style="vertical-align: middle;" /></a> 的赞助支持，本项目的 Demo 现已接入强大的 K2-thinking 模型！
